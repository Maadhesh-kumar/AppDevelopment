      ...
      <IconContext.Provider value={{ color: "black" }} >
        <nav className="navbar navbar-expand-lg navbar-light sticky-top"  >
          <div className="container-fluid my-3"  id="call" >
            ...
            <a className="navbar-brand px-4 mt-3" href="#" >
             <h3><strong>Indigo AirLines...</strong> </h3>
            </a>
            <button
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav ms-auto mx-5 " id="navhr"> {/* Changed to ml-auto for right alignment */}
                <li className="nav-item " id="navr">
                  <a className="nav-link  fs-4 px-3" id="navl" aria-current="page" href="#" onClick={()=>{navigate("/home")}}>
                    Home
                  </a>
                </li>
                <li className="nav-item" id="navr" onClick={()=>{navigate("/about")}}>
                  <a className="nav-link fs-4 px-3" id="navl" href="#">
                    About
                  </a>
                </li>
                ...
                <li className="nav-item" id="navr"  onClick={handleLogout}>
                  <a
                    className="nav-link fs-4 px-3"
                    id="navl"
                    href="#"
                    tabIndex="-1"
                    aria-disabled="true"
